...
<div class="dib">
  ...
  <div data-v-63010fd4="" class="dib dib mr2">
    <div data-v-63010fd4="" class="bg-berry br-100 p3 flex white justify-center items-center sans-serif number-bullet">
      <span data-v-63010fd4="">{{$paginator->currentPage()}}</span>
    </div>
  </div>
