...
Route::get('/correspondences/letters/tags/{id}/timeline', 'App\Http\Controllers\correspondencesController@timeline')->name('timeline.tag');

Route::get('/correspondences/letters/tags/{id}/json', 'App\Http\Controllers\correspondencesController@timelineByTag')->name('timeline.json');
...
Route::get('/maps/letter/{id}', 'App\Http\Controllers\mapsController@letterplaces')->name('letters.geosjon');
